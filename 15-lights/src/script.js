...
const rectAreaLioght = new THREE.RectAreaLight(0x4e00ff, 1, 5, 5);
rectAreaLioght.position.set(-1, 0, 1.5);
rectAreaLioght.lookAt(new THREE.Vector3());
// scene.add(rectAreaLioght);

const spotLight = new THREE.SpotLight(0x1287ee, 0.5, 7, Math.PI * 0.1, 1, 0.1);
scene.add(spotLight);
